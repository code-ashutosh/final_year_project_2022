# -- coding: utf-8 --
"""
Created on Tue Nov 17 21:40:41 2021
@author: win10
"""
...
origins = [
    "127.0.0.1:54295",
    "http://localhost:8000/final_year_project/Backend",
    "http://127.0.0.1:8000/final_year_project/Backend/predict",
    "http://localhost:5500",
    "http://127.0.0.1:5500",
    "http://myapp:5500",
    "http://myapp:5500/final_year_project/Frontend/index2.html"
]
...
model = keras.models.load_model('LSTM_27/EmotionRecognition.h5')
